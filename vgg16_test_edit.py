...
if __name__ == "__main__":
    ...
    with tf.Graph().as_default():
        ...
        with tf.Session() as sess:
            ...
            """ For fc7 MWP """
            # Get fc8 weights
            fc8_weights = np.copy((weights_val[-2])[0,0]); fc8_weights_neg = -1*np.copy((weights_val[-2][0,0]))
            ...
            fc8_weights_neg = fc8_weights_neg.clip(min = 0) # threshold weights at 0
            ...
            m = np.dot(fc8_weights_neg.T, fc7_activations) # 1000 x 1
            n = P['fc8'] / m # 1000 x 1
            o = np.dot(fc8_weights_neg, n) # 4096 x 1
            P['fc7_neg'] = fc7_activations * o ; P['fc7_contrast'] = P['fc7'] - P['fc7_neg'];
